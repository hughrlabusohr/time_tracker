...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { date: @time_entry.date, developer_id: @time_entry.developer_id, duration: @time_entry.duration, project_id: @time_entry.project_id }
    end
  ...
  test "should update time_entry" do
    patch :update, id: @time_entry, time_entry: { date: @time_entry.date, developer_id: @time_entry.developer_id, duration: @time_entry.duration, project_id: @time_entry.project_id }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
